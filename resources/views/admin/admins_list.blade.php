...
<div class="container">
  ...
  <h1 class="header">Lista Adminów</h1>
  ...
  <div class="container mt-5 mb-5">
      ...
      <div class="row mb-5 text-center">
          ...
          <div class="ms-auto me-auto col-10 mb-12 col-md-12">
            <a href="/add_admin"><button class="btn buy_button serach_button w-75">Dodaj Admina</button></a>
          </div>
            ...
            @forelse ($admins as $f)
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                       ...
                       <a href="/delete_admin/{{$f->id}}" class="btn">Usuń</a>
                    </div>
                 </div>
              </div>
            @empty

                <h4 class="col-12 text-center">Brak adminów do wyświetlenia!</h4>
