...
<div class="container">
    <h1 class="header">Edytuj Film</h1>

    <div class="container mt-5 mb-5">
        <form method="POST" action="/edit_film_admin/{{$film[0]->id}}">
            @csrf <!-- {{ csrf_field() }} -->
            <div class="form-row align-items-center">
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <div class="input-group">
                  ...
                  <input name="tytul" type="text" class="form-control" value="{{$film[0]->tytul}}">
                </div>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <div class="input-group">
                  ...
                  <input name="rezyser" type="text" class="form-control" value="{{$film[0]->rezyser}}">
                </div>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <select name="gatunek" class="custom-select" id="inputGroupSelect03">
                    <option @if($film[0]->genres_id == 1) selected @endif value="1">Akcja</option>
                    <option @if($film[0]->genres_id == 2) selected @endif value="2">Horror</option>
                    <option @if($film[0]->genres_id == 3) selected @endif value="3">Fantasy</option>
                    <option @if($film[0]->genres_id == 4) selected @endif value="4">Animowany</option>
                    <option @if($film[0]->genres_id == 5) selected @endif value="5">Dreszczowiec</option>
                    <option @if($film[0]->genres_id == 6) selected @endif value="6">Komedia</option>
                    <option @if($film[0]->genres_id == 7) selected @endif value="7">Wojenny</option>
                    <option @if($film[0]->genres_id == 8) selected @endif value="8">Przygodowy</option>
                  </select>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <div class="input-group">
                  ...
                  <input name="produkcja" type="text" class="form-control" value="{{$film[0]->produkcja}}">
                </div>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <div class="input-group">
                  ...
                  <input name="rok_produkcji" type="number" min="1" data-bind="value:replyNumber" class="form-control number-form" step="1" value="{{$film[0]->rok_produkcji}}">
                </div>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <div class="input-group">
                  ...
                  <input name="czas_trwania" type="number" min="1" data-bind="value:replyNumber" class="form-control number-form" step="1" value="{{$film[0]->czas_trwania}}">
                </div>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <div class="input-group">
                  ...
                  <input name="ocena" type="number" min="1" data-bind="value:replyNumber" class="form-control number-form" step="0.01" value="{{$film[0]->ocena}}">
                </div>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <div class="input-group">
                  <textarea name="opis" class="form-control" id="exampleFormControlTextarea1" rows="5">{{$film[0]->opis}}</textarea>
                </div>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <div class="input-group">
                  ...
                  <input name="link_grafika" type="text" class="form-control" value="{{$film[0]->link_grafika}}">
                </div>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <div class="input-group">
                  ...
                  <input name="link_film" type="text" class="form-control" value="{{$film[0]->link_film}}">
                </div>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                ...
                <div class="input-group">
                  ...
                  <input value="{{$film[0]->cena}}" name="cena" type="number" min="1" data-bind="value:replyNumber" class="form-control number-form" step="0.01">
                </div>
              </div>
              ...
              <div class="col-auto my-1 ms-auto me-auto text-center">
                <button type="submit" class="btn signin_button">Edytuj</button>
              </div>
            </div>
