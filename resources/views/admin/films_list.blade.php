...
<div class="container">
  ...
  <div class="container mt-5 mb-5">
    ...
    <form action="/films_serach_admin" method="POST">
        @csrf <!-- {{ csrf_field() }} -->
      ...
      <div class="row mb-5 text-center">
          ...
          <div class="ms-auto me-auto col-10 mb-12 col-md-12">
            <a href="/add_film"><button class="btn buy_button serach_button w-75">Dodaj film</button></a>
          </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-3 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                       ...
                       <a href="/edit_film/{{$f->id}}" class="btn mb-2">Edytuj film</a>
                       <a href="/delete_film/{{$f->id}}" class="btn">Usuń film</a>
                    </div>
                 </div>
              </div>
