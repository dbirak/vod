            ...
            <div class="container mt-5 mb-15">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-center mb-4">
                        <h2 style="font-size: 35px;">{{$data_zak2}}r.</h2>
                    </div>
                </div>
            </div>

            <div class="container mt-5 mb-5 mr-auto ms-auto">
                <iframe width="100%" height="600" src="{{$f->link_film}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        @else
