...
<div class="container">
    ...
    <h1 class="header">Logowanie do serwisu</h1>
    ...
    <div class="container mt-5 mb-5">
        <form method="POST" action="/login_user">
            ...
            <div class="form-row align-items-center">
              ...
              <h5 class="text-center">Nie masz konta? <a href="/register" class="hyperlink_login">Zajerestruj się!</a></h5>

              <br>

              <h5 class="error">@error('email') {{$message}}<br> @enderror @error('password') {{$message}} @enderror @if(Session::has('fail')) {{Session::get('fail')}}  @endif</h5>
              <br>

              <div class="col-auto my-1 ms-auto me-auto text-center">
              </div>
              <div class="col-auto my-1 ms-auto me-auto text-center">
                <button type="submit" class="btn signin_button">Zaloguj się</button>
              </div>
            </div>
