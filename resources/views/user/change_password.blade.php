...
<div class="container">
    <h1 class="header">Zmień Hasło</h1>

    <div class="container mt-5 mb-5">
        <form method="POST" action="/change_password_user">
        @csrf <!-- {{ csrf_field() }} -->
            <div class="form-row align-items-center">

              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                <label class="label-form" for="inlineFormInputGroupUsername">Obecne hasło</label>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                <label class="label-form" for="inlineFormInputGroupUsername">Nowe hasło</label>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <div class="input-group-text"><i class="fa-solid fa-key"></i></div>
                  </div>
                  <input name="haslo2" type="password" class="form-control" >
                </div>
              </div>
              ...
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                <label class="label-form" for="inlineFormInputGroupUsername">Powtórz nowe hasło</label>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <div class="input-group-text"><i class="fa-solid fa-key"></i></div>
                  </div>
                  <input name="haslo3" type="password" class="form-control">
                </div>
              </div>

              <br>

              <h5 class="error">@error('haslo') {{$message}} <br>@enderror @error('haslo2') {{$message}} <br>@enderror @error('haslo3') {{$message}} <br>@enderror @if(Session::has('fail')) {{Session::get('fail')}}  @endif</h5>
              <br>

              <div class="col-auto my-1 ms-auto me-auto text-center">
              </div>
              <div class="col-auto my-1 ms-auto me-auto text-center">
                <button type="submit" class="btn signin_button">Zmień</button>
              </div>
            </div>
