...
<div class="container">
    <h1 class="header">Edytuj Dane</h1>

    <div class="container mt-5 mb-5">
        <form method="POST" action="edit_name_user">
            @csrf <!-- {{ csrf_field() }} -->
            <div class="form-row align-items-center">
                ...
                <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                    ...
                    <div class="input-group">
                      ...
                      <input name="imie" type="text" class="form-control" value="{{Auth::user()->imie}}">
                    </div>
                  </div>
                  ...
                  <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                    ...
                    <div class="input-group">
                      ...
                      <input name="nazwisko" type="text" class="form-control" value="{{Auth::user()->nazwisko}}">
                    </div>
                  </div>

              <br>

              <h5 class="error">@error('imie') {{$message}} <br>@enderror @error('nazwisko') {{$message}} <br>@enderror @if(Session::has('fail')) {{Session::get('fail')}}  @endif</h5>
              <br>
