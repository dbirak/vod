...
<html lang="pl">
  ...
  <body class="d-flex flex-column min-vh-100 p-0">
    ...
    <!-- Formularz doładowania konta -->
<div class="container">
    <h1 class="header">Doładuj Konto</h1>

    <div class="container mt-5 mb-5">
        <form method="POST" action="recharge_user">
            @csrf <!-- {{ csrf_field() }} -->
            <div class="form-row align-items-center">
              <div class="col-10 col-sm-10 col-md-8 col-lg-6 col-xl-5 my-1 form-container ms-auto me-auto">
                <label class="label-form" for="inlineFormInputGroupUsername">Kwota</label>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <div class="input-group-text"><i class="fa-solid fa-money-bill-1"></i></div>
                  </div>
                  <input name="kwota" type="number" min="1" data-bind="value:replyNumber" class="form-control number-form" step="0.01">
                </div>
              </div>

              <br>

              <h5 class="error">@error('kwota') {{$message}} <br>@enderror @if(Session::has('fail')) {{Session::get('fail')}}  @endif</h5>
              <br>

              <div class="col-auto my-1 ms-auto me-auto text-center">
              </div>
              <div class="col-auto my-1 ms-auto me-auto text-center">
                <button type="submit" class="btn signin_button">Doładuj</button>
              </div>
            </div>
